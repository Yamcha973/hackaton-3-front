    ...
    return (
      <div className='integral'>
        ...
        <div className='buttonContainer2'>
          ...
          <button key='acces_patient' onClick={(event) => { this.changePage('patient_page'); this.changePatient('Brigite'); }} > Sarah </button>
          <button key='acces_patient2' onClick={(event) => { this.changePage('patient_page2'); this.changePatient('Heloise'); }} > Nico </button>
        </div>
      </div>
    )
  }
